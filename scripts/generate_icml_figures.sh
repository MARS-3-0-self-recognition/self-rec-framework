...
#
# This script reads the figure mappings from scripts/copy_icml_figures.sh
...
# Extract and source the FIGURES array from copy_icml_figures.sh
# Extract lines from "FIGURES=(" to the matching ")"
FIGURES_DEF=$(awk '/^FIGURES=\($/,/^\)$/ {print}' "$SCRIPT_DIR/copy_icml_figures.sh")
eval "$FIGURES_DEF"
...
# FIGURES array is now sourced from copy_icml_figures.sh above
...
echo ""
echo "Next step: Run scripts/copy_icml_figures.sh to copy figures to ICML_figures/"
